...
export const declaracionDeFe = {
  ...
  "Sección C": {
    "La Iglesia": {
      "texto": "La Iglesia es la institución del Nuevo Testamento, fundada por Cristo mediante su sacrificio vicario en la cruz del Calvario. La misma está compuesta por aquellos que se constituyen en hijos de Dios al recibir a Cristo como su Salvador. Como institución divina, su permanencia está garantizada, a pesar de los ataques del enemigo. La Iglesia está compuesta por los santos que están en la tierra (la parte visible), y todos aquellos muertos en Cristo desde el Calvario hasta el rapto de los salvados. La Iglesia es en su expresión humana más amplia, una composición étnica de extensión universal."
    }
  }
};
